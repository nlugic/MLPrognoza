...
namespace MLPrognoza.Data.Models
{
    public class WeatherModel
    {
        ...
        public DateTime Time { get; set; } // vreme merenja, mozda suvisno
        public int WindSpeed { get; set; } // brzina vetra u m/s
        public int Temperature { get; set; } // temperatura u C
        public int DewPointTemperature { get; set; } // temperatura kondenzacije u C, mozda suvisno
        public float AtmosphericPressure { get; set; } // atmosferski pritisak
        public float[] Precipitation { get; set; } // padavine u poslednjih sat/6/12/24 sata
        public float SnowDepth { get; set; } // dubina snega, mozda suvisno
